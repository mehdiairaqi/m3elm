                      ...
                      <div class="nav-outer">
                          <ul class="nav navbar-nav">
                            <li class=""><a href="{{ url('/') }}">Home</a></li>
                              <li class="active dropdown"><a href="{{ url('plombier') }}">plombier</a></li>
                              <li class=""><a href="{{ url('chaufagisste') }}">Chauffagiste <span class="menu-label hot-menu hidden-xs">hot</span></a></li>
